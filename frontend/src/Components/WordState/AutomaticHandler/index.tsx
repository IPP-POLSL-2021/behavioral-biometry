...
const AutomaticHandler = ({letters, setLetterDown, setLetterBackUp, onPromptFilled, classNames}: {classNames?: string, onPromptFilled: (items: Itoken[]) => void, letters: Itoken[], setLetterBackUp: () => void, setLetterDown: () => void}) => {
