...
namespace backend.Migrations
{
    ...
    [Migration("20230524203658_fixedPrompts")]
    partial class fixedPrompts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.fixedPrompts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.Result", b =>
                {
                    b.HasOne("backend.Models.User", "loggedUser")
                        .WithMany()
                        .HasForeignKey("userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
